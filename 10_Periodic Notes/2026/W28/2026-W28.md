...
AND (
  dateformat(default(date(created), file.cday), "kkkk-'W'WW") = "2026-W28"
  OR dateformat(file.mtime, "kkkk-'W'WW") = "2026-W28"
)
...
WHERE file.ext = "md"
AND dateformat(default(date(created), file.cday), "kkkk-'W'WW") = "2026-W28"
...
WHERE file.ext = "md"
AND status != "unread"
AND dateformat(file.mtime, "kkkk-'W'WW") = "2026-W28"
SORT file.mtime DESC
```
